...
var ajaxService = function ajaxService(address, city) {
  ...
  var key = "19i395MIl804sPv8ZLCi";
  return fetch("".concat(url).concat(city, "&address=").concat(address, "&key=").concat(key)).then(function (respone) {
    return respone.json();
  });
};
...
var searchCode = function searchCode() {
  document.querySelector('form').addEventListener('submit', function (e) {
    ...
    (0,_ajaxService__WEBPACK_IMPORTED_MODULE_0__["default"])(searchTerm, city).then(function (result) {
      ...
      var postalCode = searchResponse.data[0].post_code;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkjs1"] = self["webpackChunkjs1"] || [];
